...
if not os.path.exists('/home/pi/Documentos/registros'):
    os.makedirs('/home/pi/Documentos/registros')
...
classificador_carro = cv2.CascadeClassifier('/home/pi/Documentos/dados/custom haar cascade/classifier/cascade.xml')
# =============================================================================
# classificador_corpo = cv2.CascadeClassifier('/home/pi/Documentos/classificadores/haarcascade_fullbody.xml')
# classificador_rosto = cv2.CascadeClassifier('/home/pi/Documentos/classificadores/haarcascade_frontalface_alt.xml')
# =============================================================================
...
#função para definir os pinos como entrada
def definir_pinos_como_entrada(numero_pino):
    """Função utilizada para definir determinada entrada como IN,\n
    :numero_pino = numeração da porta (BOARD)"""
...
definir_pinos_como_entrada(bt_reset)
...
definir_estado_porta(bt_reset,desligar)
...
img_referencia = cv2.imread("/home/pi/Documentos/dados/img_ref/img_46.jpg")
...
#distancia_focal_ref = round(distancia_focal_ref,2)
...
def verificar_objeto(lado_objeto,aproximacao_objeto,distancia):
    ...
    if distancia > dist_segura and aproximacao_objeto == "Distancia segura":
        ...
        if lado_objeto=="Lado esquerdo":
            ...
            print("atenção lado esquerdo")
        elif lado_objeto=="Lado direito":
            estado_atencao_direita()
            print("atenção lado direito")
        ...
        cv2.imwrite("/home/pi/Documentos/registros/img_obj_" + hoje + str(y+h) + ".jpg", frame)
